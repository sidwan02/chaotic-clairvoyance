...
class worker_node(Node):
    ...
    def execute_blocks(self):
        ...
        start_time = 0.22999999999999998
        self.timeHelper.sleepUntil(start_time)
        takeoff(groupState, 0.6, 3)
        # Block Name: move forward
        start_time = 3.629999999999998
        self.timeHelper.sleepUntil(start_time)
        goto_velocity_relative_position(groupState, 1.6,0,0,0.075)
        # Block Name: moveback
        start_time = 19.989999999999995
        self.timeHelper.sleepUntil(start_time)
        goto_velocity_relative_position(groupState, -1.5,0,0,0.075)
