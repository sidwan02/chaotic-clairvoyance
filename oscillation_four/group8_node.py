...
class worker_node(Node):
    ...
    def execute_blocks(self):
        ...
        start_time = 0.19999999999999996
        self.timeHelper.sleepUntil(start_time)
        takeoff(groupState, 1.5, 3)
        goto_velocity_relative_position(groupState, -0.5, 0, 0, 0.25)
        # Block Name: 0.1
        start_time = 5.499999999999995
        self.timeHelper.sleepUntil(start_time)
        addTrajectories(
            groupState,
            lambda groupState: goto_velocity_relative_position(
                groupState, 0, 0, -0.1, 0.25
            ),
            lambda groupState: goto_velocity_relative_position(
                groupState, 0.15, 0, 0, 0.0625
            ),
        )
        addTrajectories(
            groupState,
        ...
        # Block Name: 0.2
        start_time = 9.499999999999998
        self.timeHelper.sleepUntil(start_time)
        addTrajectories(
            groupState,
            lambda groupState: goto_velocity_relative_position(
                groupState, 0, 0, -0.2, 0.25
            ),
            lambda groupState: goto_velocity_relative_position(
                groupState, 0.2, 0, 0, 0.1
            ),
        )
        addTrajectories(
            groupState,
        ...
        addTrajectories(
            groupState,
            lambda groupState: goto_velocity_relative_position(
                groupState, 0, 0, -0.3, 0.25
            ),
            lambda groupState: goto_velocity_relative_position(
                groupState, 0.2, 0, 0, 0.125
            ),
        )
        addTrajectories(
            groupState,
        ...
        # Block Name: 0.4
        start_time = 17.50500000000001
        self.timeHelper.sleepUntil(start_time)
        addTrajectories(
            groupState,
            lambda groupState: goto_velocity_relative_position(
                groupState, 0, 0, -0.4, 0.25
            ),
            lambda groupState: goto_velocity_relative_position(
                groupState, 0.2, 0, 0, 0.125
            ),
